...
export default function ActivePosts() {
  ...
  if (activePosts.length === 0)
    return (
      <div>
        <span className={styles.noContent}>You don’t have any active ads</span>
    ...
    >
      ...
      <div className={styles.postInfo}>
        ...
        <span className={styles.price}>
          {item.price.toLocaleString("en-US")} Birr
        </span>
...
function FinishedPosts({ posts }) {
  ...
  return (
    <div className={styles.finishedPanel}>
      <span className={styles.finishedTitle}>Finished Listings</span>
